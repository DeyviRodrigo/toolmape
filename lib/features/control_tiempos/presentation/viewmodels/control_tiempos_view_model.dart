...
class ControlTiemposViewModel extends StateNotifier<ControlTiemposState> {
  ...
  void changeEstadoFilter(VolqueteEstado? estado) {
    if (estado == state.estadoFilter) return;
...
class ControlTiemposState {
  ...
  final VolqueteEstado? estadoFilter;
  ...
  List<Volquete> get filteredVolquetes {
    ...
    final filtered = volquetes.where((volquete) {
      ...
      if (estadoFilter != null && volquete.estado != estadoFilter) return false;
  ...
  ControlTiemposState copyWith({
    ...
    return ControlTiemposState(
      ...
      estadoFilter: identical(estadoFilter, _sentinel)
          ? this.estadoFilter
          : estadoFilter as VolqueteEstado?,
    );
  }
}

...
const String _emojiArrowRight = '→';
const String _emojiTruckEmpty = '🚚';
const String _emojiTruckLoaded = '🚛';
const String _emojiEditPen = '✏️';
                    ...
                    Row(
                      ...
                      children: [
                        Wrap(
                          spacing: 12,
                          children: const [
                            _QuickIcon(emoji: _emojiArrowRight),
                            _QuickIcon(emoji: _emojiTruckEmpty),
                            _QuickIcon(emoji: _emojiTruckLoaded),
                            _QuickIcon(emoji: _emojiEditPen),
                          ],
                        ),
...
class _QuickIcon extends StatelessWidget {
  const _QuickIcon({required this.emoji});

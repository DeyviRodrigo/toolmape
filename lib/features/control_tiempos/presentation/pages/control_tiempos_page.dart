                      ...
                      : ListView.separated(
                          ...
                          itemBuilder: (_, index) {
                            ...
                            return _VolqueteCard(
                              ...
                              onEndCarga: () => _showSnack(
                                'Fin de carga registrado para ${volquete.codigo}.',
                              ),
              ...
              Row(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      _StatusPill(estado: volquete.estado),
                      const SizedBox(height: 8),
                      Text(
...
final List<Volquete> _initialVolquetes = [
  Volquete(
    ...
    destino: 'Beatriz 1',
    fecha: const DateTime(2025, 7, 22, 8, 45, 39),
    ...
    chute: 3,
    llegadaFrente: const DateTime(2025, 7, 22, 8, 40),
    inicioManiobra: const DateTime(2025, 7, 22, 8, 42),
    inicioCarga: const DateTime(2025, 7, 22, 8, 47),
    finCarga: null,
    ...
    eventos: const [
      const VolqueteEvento(
        ...
        fecha: const DateTime(2025, 7, 22, 8, 40),
      ),
      const VolqueteEvento(
        titulo: 'Preparación para carga',
        descripcion: 'Asignado al chute 3.',
        fecha: const DateTime(2025, 7, 22, 8, 42),
      ),
    ],
    descargas: const [
      const VolqueteDescarga(
        ...
        chute: 3,
        fechaInicio: const DateTime(2025, 7, 21, 23, 20),
        fechaFin: const DateTime(2025, 7, 21, 23, 54),
      ),
      const VolqueteDescarga(
        id: 'd101',
        ...
        chute: 2,
        fechaInicio: const DateTime(2025, 7, 20, 21, 15),
        fechaFin: const DateTime(2025, 7, 20, 21, 44),
      ),
    ],
  ),
  Volquete(
    ...
    destino: 'Panchita 2',
    fecha: const DateTime(2025, 7, 16, 9, 8, 22),
    ...
    chute: 4,
    llegadaFrente: const DateTime(2025, 7, 16, 8, 55),
    inicioManiobra: const DateTime(2025, 7, 16, 8, 57),
    inicioCarga: const DateTime(2025, 7, 16, 9, 1),
    finCarga: const DateTime(2025, 7, 16, 9, 8),
    ...
    eventos: const [
      const VolqueteEvento(
        ...
        fecha: const DateTime(2025, 7, 16, 8, 57),
      ),
      const VolqueteEvento(
        titulo: 'Fin de carga',
        descripcion: 'Carga completada y verificada.',
        fecha: const DateTime(2025, 7, 16, 9, 8),
      ),
    ],
    descargas: const [
      const VolqueteDescarga(
        ...
        chute: 4,
        fechaInicio: const DateTime(2025, 7, 15, 18, 10),
        fechaFin: const DateTime(2025, 7, 15, 18, 40),
      ),
      const VolqueteDescarga(
        id: 'd103',
        ...
        chute: 5,
        fechaInicio: const DateTime(2025, 7, 14, 20, 5),
        fechaFin: const DateTime(2025, 7, 14, 20, 45),
      ),
    ],
  ),
  Volquete(
    ...
    destino: 'Beatriz 2',
    fecha: const DateTime(2025, 7, 16, 9, 2, 12),
    estado: VolqueteEstado.incompleto,
    tipo: VolqueteTipo.carga,
    ...
    chute: 2,
    llegadaFrente: const DateTime(2025, 7, 16, 8, 48),
    inicioManiobra: const DateTime(2025, 7, 16, 8, 50),
    inicioCarga: const DateTime(2025, 7, 16, 8, 56),
    finCarga: null,
    ...
    eventos: const [
      const VolqueteEvento(
        ...
        fecha: const DateTime(2025, 7, 16, 8, 48),
      ),
      const VolqueteEvento(
        titulo: 'Inicio de carga',
        descripcion: 'Excavadora ZX 350 inicia turno.',
        fecha: const DateTime(2025, 7, 16, 8, 56),
      ),
    ],
    descargas: const [
      const VolqueteDescarga(
        ...
        procedencia: 'Beatriz 2',
        chute: 2,
        fechaInicio: const DateTime(2025, 7, 12, 7, 30),
        fechaFin: const DateTime(2025, 7, 12, 7, 58),
      ),
      const VolqueteDescarga(
        id: 'd105',
        volquete: '(V04) Volq. FR D7V-760',
        ...
        chute: 1,
        fechaInicio: const DateTime(2025, 7, 11, 22, 15),
        fechaFin: const DateTime(2025, 7, 11, 22, 44),
      ),
    ],
  ),
  Volquete(
    ...
    operador: '(E03) Carg. AD L150F',
    destino: 'Beatriz 3',
    fecha: const DateTime(2025, 7, 16, 8, 58, 2),
    estado: VolqueteEstado.completo,
    ...
    chute: 5,
    llegadaFrente: const DateTime(2025, 7, 16, 8, 30),
    inicioManiobra: const DateTime(2025, 7, 16, 8, 32),
    inicioCarga: const DateTime(2025, 7, 16, 8, 34),
    finCarga: const DateTime(2025, 7, 16, 8, 58),
    ...
    eventos: const [
      const VolqueteEvento(
        ...
        fecha: const DateTime(2025, 7, 16, 8, 40),
      ),
      const VolqueteEvento(
        titulo: 'Finalización',
        descripcion: 'Peso registrado 18.7 tn.',
        fecha: const DateTime(2025, 7, 16, 8, 58),
      ),
    ],
    descargas: const [
      const VolqueteDescarga(
        ...
        procedencia: 'Beatriz 3',
        chute: 5,
        fechaInicio: const DateTime(2025, 7, 13, 12, 5),
        fechaFin: const DateTime(2025, 7, 13, 12, 32),
      ),
    ],
  ),
  Volquete(
    ...
    operador: '(E01) Excav. C 340-01',
    destino: 'Panchita 1',
    fecha: const DateTime(2025, 7, 16, 8, 55, 10),
    estado: VolqueteEstado.incompleto,
    tipo: VolqueteTipo.descarga,
    equipo: VolqueteEquipo.excavadora,
    maquinaria: '(E01) Excav. C 340-01',
    ...
    chute: 1,
    llegadaFrente: const DateTime(2025, 7, 16, 8, 15),
    inicioManiobra: const DateTime(2025, 7, 16, 8, 18),
    inicioCarga: const DateTime(2025, 7, 16, 8, 24),
    finCarga: null,
    ...
    eventos: const [
      const VolqueteEvento(
        ...
        fecha: const DateTime(2025, 7, 16, 8, 15),
      ),
    ],
    descargas: const [
      const VolqueteDescarga(
        ...
        chute: 1,
        fechaInicio: const DateTime(2025, 7, 14, 14, 40),
        fechaFin: const DateTime(2025, 7, 14, 15, 5),
      ),
    ],
  ),
  Volquete(
    ...
    operador: '(E02) Excav. ZX 350',
    destino: 'Relavado',
    fecha: const DateTime(2025, 7, 16, 8, 54, 44),
    estado: VolqueteEstado.completo,
    tipo: VolqueteTipo.carga,
    equipo: VolqueteEquipo.excavadora,
    maquinaria: '(E02) Excav. ZX 350',
    ...
    chute: 4,
    llegadaFrente: const DateTime(2025, 7, 16, 8, 12),
    inicioManiobra: const DateTime(2025, 7, 16, 8, 16),
    inicioCarga: const DateTime(2025, 7, 16, 8, 19),
    finCarga: const DateTime(2025, 7, 16, 8, 54),
    ...
    descargas: const [
      const VolqueteDescarga(
        ...
        procedencia: 'Relavado',
        chute: 4,
        fechaInicio: const DateTime(2025, 7, 10, 6, 0),
        fechaFin: const DateTime(2025, 7, 10, 6, 34),
      ),
    ],
  ),
  Volquete(
    ...
    operador: '(E03) Carg. AD L150F',
    destino: 'Beatriz 1',
    fecha: const DateTime(2025, 7, 8, 8, 43, 12),
    estado: VolqueteEstado.incompleto,
    tipo: VolqueteTipo.carga,
    equipo: VolqueteEquipo.cargador,
    maquinaria: '(E03) Carg. AD L150F',
    ...
    chute: 2,
    llegadaFrente: const DateTime(2025, 7, 8, 8, 16),
    inicioManiobra: const DateTime(2025, 7, 8, 8, 20),
    inicioCarga: const DateTime(2025, 7, 8, 8, 32),
    finCarga: null,
    ...
    eventos: const [
      const VolqueteEvento(
        ...
        fecha: const DateTime(2025, 7, 8, 8, 16),
      ),
    ],
    descargas: const [
      const VolqueteDescarga(
        ...
        procedencia: 'Beatriz 1',
        chute: 2,
        fechaInicio: const DateTime(2025, 7, 6, 9, 20),
        fechaFin: const DateTime(2025, 7, 6, 9, 50),
      ),
      const VolqueteDescarga(
        id: 'd110',
        volquete: '(V11) Volq. SR V3R-770',
        procedencia: 'Beatriz 3',
        chute: 5,
        fechaInicio: const DateTime(2025, 7, 5, 17, 5),
        fechaFin: const DateTime(2025, 7, 5, 17, 32),
      ),
    ],
  ),
];
